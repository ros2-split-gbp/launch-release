...
Requires:       ros-rolling-osrf-pycommon-devel
...
%package runtime
Summary:        Runtime-only files for launch package
...
BuildRequires:  ros-rolling-osrf-pycommon-devel
...
%description runtime
Runtime-only files for launch package
...
for f in \
    ...
    /opt/ros/rolling/share/launch/cmake/ \
    /opt/ros/rolling/share/launch/package.dsv \
    /opt/ros/rolling/share/launch/package.xml \
; do
...
%exclude /opt/ros/rolling/share/launch/cmake
%exclude /opt/ros/rolling/share/launch/package.dsv
%exclude /opt/ros/rolling/share/launch/package.xml
