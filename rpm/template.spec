...
Requires:       ros-rolling-launch-testing-devel
...
%package runtime
Summary:        Runtime-only files for launch_testing_ament_cmake package
...
%if 0%{?with_tests}
BuildRequires:  ros-rolling-ament-cmake-copyright-devel
BuildRequires:  ros-rolling-launch-testing-devel
BuildRequires:  ros-rolling-python-cmake-module-devel
%endif

%description runtime
Runtime-only files for launch_testing_ament_cmake package
...
for f in \
    ...
    /opt/ros/rolling/share/launch_testing_ament_cmake/cmake/ \
    /opt/ros/rolling/share/launch_testing_ament_cmake/package.dsv \
    /opt/ros/rolling/share/launch_testing_ament_cmake/package.xml \
; do
...
%exclude /opt/ros/rolling/share/launch_testing_ament_cmake/cmake
%exclude /opt/ros/rolling/share/launch_testing_ament_cmake/package.dsv
%exclude /opt/ros/rolling/share/launch_testing_ament_cmake/package.xml
